# plan-sim-20260923-102-r2: one trap at rest, the width a camera should see

*Generated from the JSON beside this file, which is authoritative (P3). Status: VALIDATED.*

One sphere of 5 um in a harmonic trap of 0.5 pN/um, fluid at rest. Timestep 0.0004 s, start-up 1 s discarded, then a record of 20 s saved every 0.008 s.
