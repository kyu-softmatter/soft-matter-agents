# Plan plan-sim-20260923-041-r6

*Generated from `v6_plan_simulation_sim-20260923-041.json`. The JSON is authoritative; editing this file changes nothing (P3).*

- **question** `sim-20260923-041`, revision 6, status `VALIDATED`
- **purpose** characterize · **intent** explore · **sweep** over `peclet_number_steric` and `packing_fraction`
- **from** goal `goal-sim-20260923-041-r6` via synthesis `synthesis-sim-20260923-041-r6`
...
| mid_max | 10 1 | 0.5 1 | 0.005 s | 200 um | 1000 1 | 6,000,000,000 1 | yes |
...
Cost: 1000 s of wall clock and 1 GB of disk for the kept cells, at an assumed rate of ten million particle-steps per second (`particle_step_rate`).
