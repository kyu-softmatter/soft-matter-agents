...
| **`019` — detect the engine, say so when missing** | `cd simulation_agent && python3 -c "from src import engine_check" 2>/dev/null && grep -q 'stopgap' simulation_agent/src/environment.yml && echo TAKEN \|\| echo OPEN` |
