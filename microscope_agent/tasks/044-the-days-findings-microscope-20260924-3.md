# 044 — the day's findings for the store: microscope-20260924-3

Written by `manager-microscope-20260924-1`. You read this; you do not edit it
(§6.2-2).

**Assigned to `microscope-20260924-3`.** The person asked, as the day's last request, that
...
- **the confocal lines have no power calibration anywhere** you read, and
  where you looked. The person says one exists; the librarian is asking
  where. List what you found, not what the person remembers
- what `disk_survives_kill.py` does and does not establish (it was never
  run in the prior project)
- the killed-process state: a line can be left unblanked with the fiber
  shutter open, and no software here can close either
- your rulings are already in `rulings.jsonl`. Do not repeat them;
  reference that file

## What to do

**List everything you established today** in one file,
**`microscope_agent/findings/microscope-20260924-3-20260924.json`**, in the shape
