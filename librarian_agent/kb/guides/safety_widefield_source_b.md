# Safety guide: Widefield light engine B (a Lumencor Spectra III or Aura III -- which one is not yet known)
...
- **The two widefield light engines' manuals -- the Lumencor Spectra III and Aura III.** Both are high-power LED light engines lighting the sample on this bench; their manufacturer's safety statements and output figures are not on this computer. Which channel id is which engine is itself open, so the gap is filed against both. What would close it: the Lumencor Spectra III and Aura III user manuals.
