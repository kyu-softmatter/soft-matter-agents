# Safety guide: Spinning-disk confocal unit (Yokogawa CSU-W1)
...
- **The spinning-disk confocal unit's hardware and safety manual.** It carries the confocal laser through its own shutter and disk, and its safety guide has no manufacturer's statement to give. What would close it: the Yokogawa CSU-W1 instruction manual.
