# Safety guide: Patterned illumination (Mightex Polygon1000)
...
- **The DMD's hardware and safety manual.** The archive holds only a two-page Micro-Manager setup note and a Readme, neither with a safety statement. What would close it: the Mightex Polygon1000 user manual.
