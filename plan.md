...
**And the residue carries the deletion.** Whoever finds no positions reads why in the file that is still there -- that they were deleted, when, and **which declared criterion fired** -- rather than hunting a sibling. A record that cannot say what left it is not a record of the deletion.
